...
It should work out of the box, but you may wish to do some additional
configuration.

If you wish to add a torrent, press <BACKSPACE> and give it's location.
...
If you are already running rTorrent outside of Emacs and wish to keep doing
...
Add something like this to your init.el or customize "Mentor Rtorrent External
Rpc":

: (setq mentor-rtorrent-external-rpc "scgi://localhost:5000")
: (setq mentor-rtorrent-external-rpc "scgi://~/.rtorrent.rpc")
: (setq mentor-rtorrent-external-rpc "scgi:///path/to/.rtorrent.rpc")
